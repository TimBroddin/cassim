  ...
  const questions = [
    {
      ...
      default: config.nginx_configs ? config.nginx_configs : "/etc/nginx/",
    ...
    },
    {
      ...
      type: "input",
      message:
        "What domain is your base domain? Cassim wil make subdomains based on this domain (for example: 3000.sandbox.example.com).",
